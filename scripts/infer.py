...
def main() -> None:
    ...
    parser.add_argument("--output_dir", type=str, default="/data/yjy_data/conditional-flow-matching/outputs_bs12/result_1000", required=False)
    parser.add_argument("--checkpoint", type=str, default="/data/yjy_data/conditional-flow-matching/outputs_bs12/checkpoints/ckpt_100000.pt", required=False)
